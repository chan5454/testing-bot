...
pub struct Settings {
    ...
    pub source_exit_favorable_momentum_bps: u32,
    ...
    pub enable_trailing_profit_exit: bool,
    pub profit_protect_min_pnl_pct: Decimal,
    pub profit_protect_reversal_bps: u32,
...
impl Settings {
    ...
    pub fn default_for_tests(data_dir: PathBuf) -> Self {
        Self {
            ...
            source_exit_favorable_momentum_bps: 120,
            ...
            enable_trailing_profit_exit: true,
            profit_protect_min_pnl_pct: Decimal::new(3, 2),
            profit_protect_reversal_bps: 200,
    ...
    pub fn from_env() -> Result<Self> {
        ...
        Ok(Self {
            ...
            max_price_move_since_source_bps: parse_or_default(
                "MAX_PRICE_MOVE_SINCE_SOURCE_BPS",
                300_u32,
            )?,
            source_exit_partial_retain_pct: parse_or_default_decimal(
                "SOURCE_EXIT_PARTIAL_RETAIN_PCT",
                Decimal::new(5, 1),
            )?,
            source_exit_favorable_momentum_bps: parse_or_default(
                "SOURCE_EXIT_FAVORABLE_MOMENTUM_BPS",
                120_u32,
            )?,
            ...
            enable_trailing_profit_exit: parse_or_default("ENABLE_TRAILING_PROFIT_EXIT", true)?,
            profit_protect_min_pnl_pct: parse_or_default_decimal(
                "PROFIT_PROTECT_MIN_PNL_PCT",
                Decimal::new(3, 2),
            )?,
            profit_protect_reversal_bps: parse_or_default("PROFIT_PROTECT_REVERSAL_BPS", 200_u32)?,
