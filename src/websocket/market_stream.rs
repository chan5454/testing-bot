...
mod tests {
    ...
    fn test_settings() -> Settings {
        ...
        settings.polymarket_market_ws = "wss://example.com/ws/market".to_owned();
        settings.polymarket_user_ws = "wss://example.com/ws/user".to_owned();
        settings.polymarket_activity_ws = "wss://example.com/ws/activity".to_owned();
        settings.target_profile_addresses = vec!["0xabc".to_owned()];
        settings.start_capital_usd = Decimal::ZERO;
        settings.market_subscription_batch_size = 250;
        settings.market_subscription_delay = Duration::from_millis(20);
        settings
    }
